        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                builder.UseSqlServer(
                    "Server=TIMI-PC;Database=BiteBlissDB;TrustServerCertificate=True;Trusted_Connection=True;Encrypt=True"
                    );

                BiteBlissDBContext dbContext = new BiteBlissDBContext(builder.Options);
